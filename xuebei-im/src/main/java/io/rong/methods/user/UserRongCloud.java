 ...
 **/
public class UserRongCloud {

	private static final String UTF8 = "UTF-8";
	private static final String PATH = "userRongCloud";
	...
	public UserRongCloud(String appKey, String appSecret) {
		this.appKey = appKey;
	...
	public TokenResult register(UserModel user) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(rongCloud.getApiHostType(), appKey, appSecret, "/userRongCloud/getToken.json", "application/x-www-form-urlencoded");
	...
	public Result update(UserModel user) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(rongCloud.getApiHostType(), appKey, appSecret,
				"/userRongCloud/refresh.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);
